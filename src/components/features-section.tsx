    ...
    <div className="container mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-yellow-100 rounded-xl p-6 flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold mb-2">Battery-Free Options</h3>
          <p className="text-gray-700">Enjoy maintenance-free operation with our innovative battery-free technology options.</p>
        </div>
